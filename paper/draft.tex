...
\begin{align}
    ...
    \text{or \ }&T_i(y_i) = \tau(y_i) \cdot (y_i)\notag,
\end{align}
...
After the tax reform, the proportion of donors decreases by 2\% point.
...
In the next section, we report the results of the panel IV method which controls the self-selection of a tax deduction.
