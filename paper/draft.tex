...
{\centering \includegraphics[width=0.85\linewidth,]{C:/Users/katoo/Desktop/NASTAB/paper/draft_files/figure-latex/SummaryOutcome2-1} 

}

\caption{Average Logged Giving in Three Income Groups}\label{fig:SummaryOutcome2}
\end{figure}
