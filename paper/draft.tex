...
In the treatment effect literature, this is sometimes called ``intention-to-treat'' effect (ITT).
By this assumption,
...
Since this issue does not happen for the first one unit of donation,
...
\begin{align}
  ...
  + \Delta^k X_{it} \beta + \mu_i + \iota_t + v_{it},
\end{align}
