...
\begin{frame}{Summary of Conceptual Framework}
\protect\hypertarget{summary-of-conceptual-framework}{}
...
\protect\hypertarget{statistical-model}{}
...
\begin{frame}{Within Price Variation for Identification \(\gamma\)}
\protect\hypertarget{within-price-variation-for-identification-gamma}{}
The \emph{within} price variation can be decomposed into two variations:
...
\begin{frame}{Source of Endogenity}
\protect\hypertarget{source-of-endogenity}{}
\begin{enumerate}
\tightlist
\item
  ...
  \item
    Some papers use survey data to deal with this problem (e.g.\textasciitilde Rehavi and Shack, 2013).
  \item
...
\item
  ...
  \item
    As far as we know, only Almunia et al.\textasciitilde(2020) deal with this problem, though they used tax return data.
  \item
    \textbf{We use instrumental variable (IV) strategy to control this endogneity.}
  \end{itemize}
\end{enumerate}
\end{frame}
