...
```{r shapeEstimateElasticityByTrustGroup, eval = FALSE}
tabset <- list(
...
```{r kableEstimateElasticityByTrustGroup, include = TRUE, eval = FALSE}
knitr::kable(
    tab[1:3,],
    format = "latex",
...
## Five Quantile Groups: Intensive and Extensive Margin

Ongoing now...

```{r kableEstimateElasticityIntExtByTrustGroup, include = TRUE, eval = FALSE}
knitr::kable(
    tab[4:11,],
    format = "latex",
    caption = "Subgroup Regressions",
...
kable_styling(font_size = 9) %>% 
pack_rows("Intensive Margin", 1, 3) %>% 
pack_rows("Extensive Margin", 4, 8)
```
...
```{r kableEstimateElasticityByTrustGroup3, include = TRUE}
knitr::kable(
    tab[1:3,],
    format = "latex",
...
## Three Quantile Groups: Intensive and Extensive Margin

```{r kableEstimateElasticityIntExtByTrustGroup3, include = TRUE}
knitr::kable(
    tab[4:11,],
    format = "latex",
    caption = "Intensive- and Extensive-Margin Price Elasticity by Three Quantile Trust Groups",
    col.names = c("", "1Q", "2Q", "3Q"),
    row.names = FALSE,
    align = "lccc", 
    booktabs = TRUE, escape = TRUE, linesep = ""
...
```{r shapeEstimateElasticityByEfficientGroup, eval = FALSE}
tabset <- list(
...
```{r kableEstimateElasticityByEfficientGroup, include = TRUE, eval = FALSE}
knitr::kable(
    tab[1:3,],
    format = "latex",
    caption = "Subgroup Regressions",
...
```{r kableEstimateElasticityIntExtByEfficientGroup, include = TRUE, eval = FALSE}
knitr::kable(
    tab[4:11,],
    format = "latex",
    caption = "Subgroup Regressions",
...
```{r kableEstimateElasticityIntExtByEfficientGroup3, include = TRUE}
knitr::kable(
    tab[4:11,],
    format = "latex",
    caption = "Intensive- and Extensive-Margin Price Elasticity by Three Quantile Efficient Groups",
    col.names = c("", "1Q", "2Q", "3Q"),
    row.names = FALSE,
    align = "lccc", 
    booktabs = TRUE, escape = TRUE, linesep = ""
