...
```{stata EstimateElasticityIntensiveByTrustGroup, results = "hide"}
merge m:1 pid using "data\shape\trustid.dta"
drop _merge
...
```{r kableEstimateElasticityIntExtByTrustGroup, include = TRUE}
knitr::kable(
    tab[4:11,],
    format = "latex",
    caption = "Subgroup Regressions",
...
```{stata EstimateElasticityIntensiveByEfficientGroup, results = "hide"}
merge m:1 pid using "data\shape\balanceid.dta"
drop _merge
...
```{r kableEstimateElasticityIntExtByEfficientGroup, include = TRUE}
knitr::kable(
    tab[4:11,],
    format = "latex",
    caption = "Subgroup Regressions",
