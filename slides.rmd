...
## How to Check Presidential Transition Effect
...
1. t-test of difference in means between Moon's and Park's trust index
1. regression of the original trust index on difference in separated trust index
1. regression of the original trust index on Moon's and Park's trust index
...
## Scatter Plot b/w Separated Trust Index and Original One

```{r Scatter2Trustid, include=TRUE, fig.cap = "Scatter Plot between Difference of Separated Trust Index and Original One"}
...
## Regressions on Separated Trust Index
