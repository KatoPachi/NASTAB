...
```{r CorrDonationsTrust, include=TRUE, fig.cap="Scatter Plot between Donations and Trust Index"}

```

## Relationship between Receving Tax Benefit and Trust Index

```{r CorrTaxBenefitTrust, include=TRUE, fig.cap="Box Plot of Trust Index Grouped By Tax Benefit"}
