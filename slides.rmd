...
```{r EstimateTrustIndex, eval=FALSE}

```

```{r MergedWithTrustid, eval=FALSE}

```

## Histrogram of Trust Index

```{r HistogramTrustid, include = TRUE, fig.cap = "Histogram of Trust Index", eval=FALSE}

```

## Relationship b/w Donations and Trust Index 

```{r ScatterTrusidDonations, include=TRUE, fig.cap="Scatter Plot between Donations and Trust Index", eval=FALSE}

```

## Relationship b/w Receving Tax Benefit and Trust Index

```{r BoxpTrustidByBenefit, include=TRUE, fig.cap="Box Plot of Trust Index Grouped By Tax Benefit", eval=FALSE}

```

## Regression of Trust Index on Covariates

```{r RegTrustidOnCovariate, eval=FALSE}

```

```{r kableRegTrustidOnCovariate, include = TRUE, eval=FALSE}
knitr::kable(
    tab.indexreg,
    format = "latex",
...
```{r Scatter1Trustid, include=TRUE, fig.cap = "Scatter Plot between Trust Index under Park Geun-hye and Moon Jae-in", eval=FALSE}
...
```{r Scatter2Trustid, include=TRUE, fig.cap = "Scatter Plot between Difference of President-specific Trust Indexs and Original One", eval=FALSE}

```

## Result of Regressions on Difference b/w President-specific Trust

```{r RegTrustidOnDiff2Trustid, eval=FALSE}

```

```{r kableRegTrustidOnDiff2Trustid, include = TRUE, eval=FALSE}
knitr::kable(
    tab.dfset,
    format = "latex",
...
```{r RegTrusidonSepTrustid, eval=FALSE}

```

```{r kableRegTrusidonSepTrustid, include = TRUE, eval=FALSE}
knitr::kable(
    tab.regset,
    format = "latex",
...
```{r EstimatePElastByTrustid, eval=FALSE}
...
```{r kableEstimatePElastByTrustid, include = TRUE, eval=FALSE}
knitr::kable(
    tab.trustreg,
    format = "latex",
