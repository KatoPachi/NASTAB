...
In the treatment effect literature, this is sometimes called the "intention-to-treat" effect (ITT).
By this assumption,
we can solve the issue that the self-selection of a tax deduction ($R_{it}$) affects the giving price.
