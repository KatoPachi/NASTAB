...
```{r SummaryOutcome2, fig.cap = "Average Logged Giving in Three Income Groups", out.width = "85%", out.extra = ""}
df %>%
...
and $\text{WageEarner}_{it}$ is the wage earner dummy.
...
The latter estimation method allows the two coefficients to vary over time.
