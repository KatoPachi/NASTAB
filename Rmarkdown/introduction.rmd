...
Extant papers use survey panel data [e.g. @Rehavi2013 ; @Backus2019] to overcome the first issue and structural estimation [e.g. @Almunia2020] to overcome the second issue, although there is no research dealing with the both issues as far as we know. 
...
```{r SummaryPapers, include=TRUE, eval = doctype == "draft"}
tab2 <- data.frame(
    prob = c(rep("Issues related to income tax and tax relief system",5),
             rep("Issues related to declaration of tax and charitable giving",2),
             rep("Others",5)),
    cont = c("Change of marginal tax rate by transitory income",
             "Change of marginal tax rate by income adjustment anticipating changes in the future (e.g. income, giving price, or tax reform)",
             "Bias for estimating (permanent) income elasticity by transitory income",
             "Bias for estimating (permanent) income elasticity by income adjustment anticipating changes in the future (e.g. income, giving price, or tax reform)",
             "Change of marginal tax rate by adjusting the amount of charitable giving",
             "Sample selection bias by using tax return data",
             "Existence of declaration cost of charitable giving",
             "Censoring of those who do not contribute",
             "Existence of fixed cost for charitable giving",
             "Lack of variations of giving price for identification",
             "Overreport and underreport of charitable giving",
             "Switching items applied for deduction"),
    deal = c(rep("Usage of lead and lag of income and giving price (Omitting the year, in which the reform is conducted.)",4),
            "Usage of the marginal tax rate when the first dollar of charitable giving is conducted.",
            "Usage of survey data",
            "Usage of structural estimation",
            "Usage of Heckit estimation or quantile regression",
            "Estimation of tax price elasticity in terms of extensive margin",
            "Usage of tax reform as a source of identification",
            "Usage of policy reform which changes the cost for reporting charitable giving",
            "Developing new estimation method and usage of it"),
    Paper = c("Randolph (1995), Auten et al.(2002), Bakija and Heim (2011), Almunia et al. (2020)",
              "Bakija and Heim (2011), Fack and Landais(2010)",
              "Randolph (1995), Auten et al.(2002), Bakija and Heim (2011), Almunia et al. (2020)",
              "Bakija and Heim (2011),Fack and Landais(2010)",
              "Bakija and Heim (2011), Almunia et al. (2020), Backus and Grant(2019), Rehavi and Shack(2013), ※Auten et al.(2002)",
              "Backus and Grant(2019), Rehavi and Shack(2013)",
              "Almunia et al. (2020)",
              "Almunia et al. (2020) / Fack and Landais(2010), Fack and Landais(2016)",
              "Almunia et al. (2020), Backus and Grant(2019)",
              "Almunia et al. (2020), Fack and Landais(2010), Fack and Landais(2016)",
              "Fack and Landais(2016)",
              "Backus and Grant(2019)"),
    Note = c(rep("", 4), "Auten et al.(2002) use a structural estimation.", rep("", 5), "This is the unique problem for the tax return data.", "This is the unique problem for the U.S. tax deduction system.")
)

knitr::kable(
    tab2,
    caption = "Summary of issues on the estimation of giving price and income elasiticities.",
    col.names = c("Issues", "Contents", "Proposed method to deal with the problem", "Papers","Note"),
    row.names = FALSE,
    align = "ccccc",
    booktabs = TRUE, escape = TRUE, linesep = ""
) %>%
kable_styling(font_size = 7) %>%
collapse_rows(valign = "middle", latex_hline = "full") %>%
footnote(general_title = "", general = "Source: Own synopsis.", threeparttable = TRUE, escape = FALSE)
```
