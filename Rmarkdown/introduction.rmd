...
Corresponding to the issues, extant papers use survey panel data [e.g. @Rehavi2013 ; @Backus2019] to overcome the first issue and structural estimation [e.g. @Almunia2020] to overcome the second issue, although there is no research dealing with the both issues as far as we know. 
