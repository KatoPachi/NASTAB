...
\tightlist
\item
  Intensive-margin price elasticities are in the range between \(-1.4\) and \(-1.5\)

  \begin{itemize}
  \tightlist
  \item
    FE model w/o IV: \(-0.7\) (similar value to the estimates in the existing literature)
  \end{itemize}
\item
  Extensive-margin price elasticities are in the range between \(-1.7\) and \(-2.8\)

  \begin{itemize}
  \tightlist
  \item
    FE model w/o IV: \(-10.8\)
  \end{itemize}
\end{enumerate}
...
\begin{frame}{Expectated Results (1)}
\protect\hypertarget{expectated-results-1}{}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Expected Results (2)}
...
\begin{frame}{About LATE}
\protect\hypertarget{about-late}{}
...
\begin{frame}{Expected Price Elasticity of Three Types (1)}
\protect\hypertarget{expected-price-elasticity-of-three-types-1}{}
\begin{itemize}
\tightlist
\item
  Never declarer
...
\begin{frame}{Expected Price Elasticity of Three Types (2)}
\protect\hypertarget{expected-price-elasticity-of-three-types-2}{}
...
log(income) & \num{1.532} & \num{0.867} & \num{0.929} & \num{1.015} & \num{0.957} & \num{0.927}\\
 & (\num{1.125}) & (\num{1.126}) & (\num{1.128}) & (\num{1.125}) & (\num{1.103}) & (\num{1.102})\\
\midrule
First-stage: Instrument &  &  &  & 0.631 & 1.074 & 0.977\\
 &  &  &  & {}[459.7] & {}[519.5] & {}[666.4]\\
Num.Obs. & \num{6757} & \num{6757} & \num{6757} & \num{6757} & \num{6757} & \num{6757}\\
...
log(income) & \num{1.014}*** & \num{2.020}*** & \num{1.898}*** & \num{2.159}*** & \num{2.136}*** & \num{2.038}***\\
 & (\num{0.233}) & (\num{0.282}) & (\num{0.280}) & (\num{0.282}) & (\num{0.264}) & (\num{0.258})\\
\midrule
Implied price elasticity & -10.552*** & -1.608*** & -2.111*** & -1.830*** & -2.010*** & -2.756***\\
 & (0.281) & (0.406) & (0.381) & (0.675) & (0.459) & (0.441)\\
First-stage: Instrument &  &  &  & 0.285 & 0.800 & 0.766\\
 &  &  &  & {}[271.1] & {}[300.7] & {}[364.0]\\
Num.Obs. & \num{25494} & \num{25492} & \num{25492} & \num{25492} & \num{25492} & \num{25492}\\
Instrument &  &  &  & WE x Price & PS x Price & PS x Price\\
Method of PS &  & Pool & Separate &  & Pool & Separate\\
...
log(income) & \num{1.189}*** & \num{2.022}*** & \num{1.911}*** & \num{2.325}*** & \num{2.195}*** & \num{2.121}***\\
 & (\num{0.279}) & (\num{0.330}) & (\num{0.329}) & (\num{0.324}) & (\num{0.296}) & (\num{0.291})\\
\midrule
Implied price elasticity & -10.812*** & -1.670*** & -2.123*** & -0.897 & -2.032*** & -2.673***\\
 & (0.339) & (0.568) & (0.543) & (0.970) & (0.616) & (0.596)\\
First-stage: Instrument &  &  &  & 0.272 & 0.822 & 0.794\\
 &  &  &  & {}[151.8] & {}[174.0] & {}[202.0]\\
Num.Obs. & \num{17199} & \num{17197} & \num{17197} & \num{17197} & \num{17197} & \num{17197}\\
Instrument &  &  &  & WE x Price & PS x Price & PS x Price\\
Method of PS &  & Pool & Separate &  & Pool & Separate\\
...
log(income) & \num{1.712} & \num{1.005} & \num{1.064} & \num{0.855} & \num{0.779} & \num{0.771}\\
 & (\num{1.197}) & (\num{1.187}) & (\num{1.190}) & (\num{1.178}) & (\num{1.148}) & (\num{1.150})\\
\midrule
First-stage: Instrument &  &  &  & 0.529 & 0.937 & 0.842\\
 &  &  &  & {}[262.6] & {}[331.8] & {}[404.6]\\
Num.Obs. & \num{6247} & \num{6247} & \num{6247} & \num{6247} & \num{6247} & \num{6247}\\
Instrument &  &  &  & WE x Price & PS x Price & PS x Price\\
Method of PS &  & Pool & Separate &  & Pool & Separate\\
...
log(income) & \num{1.060}*** & \num{1.774}*** & \num{1.707}*** & \num{1.967}*** & \num{1.965}*** & \num{1.900}***\\
 & (\num{0.229}) & (\num{0.282}) & (\num{0.280}) & (\num{0.266}) & (\num{0.250}) & (\num{0.247})\\
\midrule
Implied price elasticity & -11.667*** & -3.147*** & -3.419*** & -4.182*** & -4.197*** & -4.729***\\
 & (0.294) & (0.448) & (0.419) & (0.715) & (0.487) & (0.479)\\
First-stage: Instrument &  &  &  & 0.270 & 0.773 & 0.736\\
 &  &  &  & {}[255.1] & {}[290.5] & {}[349.1]\\
Num.Obs. & \num{24984} & \num{24982} & \num{24982} & \num{24982} & \num{24982} & \num{24982}\\
Instrument &  &  &  & WE x Price & PS x Price & PS x Price\\
Method of PS &  & Pool & Separate &  & Pool & Separate\\
...
1-year lead of income &  & \num{-2.449} &  & \num{-2.347}\\
 &  & (\num{3.242}) &  & (\num{3.143})\\
\midrule
Instrument: log(first price) &  &  & 0.939 & 0.000\\
 &  &  & {}[2869.0] & {}[1000000.0]\\
Num.Obs. & \num{3584} & \num{805} & \num{3479} & \num{800}\\
\bottomrule
\end{tabular}
