...
\begin{frame}{Make Trust Index}
\protect\hypertarget{make-trust-index}{}
...
\caption{\label{tab:kableRegTrustidOnCovariate}Regression of Trust Index (Year = 2018)}
\centering
\begin{tabular}[t]{lcc}
\toprule
...
To check it, we estimate trust index using both data in 2015 and 2016
(Park's Trust index) and data in 2017 and 2018 (Moon's Trust index).
\end{frame}
...
\begin{frame}{Scatter Plot b/w Park's Trust Index and Original One}
\protect\hypertarget{scatter-plot-bw-parks-trust-index-and-original-one}{}
\begin{figure}
\centering
\includegraphics{C:/Users/katoo/Desktop/NASTAB/report/slides_files/figure-beamer/Scatter2Trustid-1.pdf}
\caption{Scatter Plot between Trust Index under Park Geun-hye and
Original One}
\end{figure}
\end{frame}

\begin{frame}{Scatter Plot b/w Moon's Trust Index and Original One}
\protect\hypertarget{scatter-plot-bw-moons-trust-index-and-original-one}{}
\begin{figure}
\centering
\includegraphics{C:/Users/katoo/Desktop/NASTAB/report/slides_files/figure-beamer/Scatter3Trustid-1.pdf}
\caption{Scatter Plot between Trust Index under Moon Jae-in and Original
One}
\end{figure}
\end{frame}

\begin{frame}{Regressions of Trust Index on Separated Trust Index}
\protect\hypertarget{regressions-of-trust-index-on-separated-trust-index}{}
\begin{table}
