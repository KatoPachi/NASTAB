...
\caption{\label{tab:kableEstimateElasticityIntExtByTrustGroup}Subgroup Regressions}
\centering
\fontsize{9}{11}\selectfont
\begin{tabular}[t]{lccccc}
\toprule
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{C:/Users/vge00/Desktop/NaSTaB/_assets/HistogramBalanceid} \caption{Histogram of Efficient Index}\label{fig:unnamed-chunk-4}
\end{figure}
\end{frame}
...
\caption{\label{tab:kableEstimateElasticityIntExtByEfficientGroup}Subgroup Regressions}
\centering
\fontsize{9}{11}\selectfont
\begin{tabular}[t]{lccccc}
\toprule
