...
\hspace{1em}X Lowest Trust & 1.291** & (0.531)\\
\hspace{1em}X Lower Trust & 0.833 & (0.514)\\
\hspace{1em}X Higher Trust & 0.275 & (0.541)\\
\hspace{1em}X Highest Trust & 0.372 & (0.531)\\
Obs & 51301 & \\
\bottomrule
\end{tabular}
\end{table}
...
\tightlist
\item
  Using data in 2013 and 2014, we regressed the interaction model again
  ...
  \end{itemize}
\item
  Using the park's trust index instead, we regressed the interaction
  ...
  \end{itemize}
\item
  Restricting to units aboslute value of president-specific trust index
  difference is less than 1 or 0.5, we regressed the interaction model
  again (year \textgreater{} 2011)

  \begin{itemize}
  \tightlist
  \item
    Last method rules out the effect of presidential transition on
    political trust because the original trust index is not affected by
...
\begin{tabular}[t]{lcccc}
\toprule
\multicolumn{1}{c}{Year} & \multicolumn{2}{c}{2013 and 2014} & \multicolumn{2}{c}{After 2012} \\
\cmidrule(l{3pt}r{3pt}){1-1} \cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5}
\multicolumn{1}{c}{Trust index} & \multicolumn{1}{c}{Original} & \multicolumn{1}{c}{Park} & \multicolumn{1}{c}{Original(Abs<1)} & \multicolumn{1}{c}{Original(Abs<0.5)} \\
\cmidrule(l{3pt}r{3pt}){1-1} \cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4} \cmidrule(l{3pt}r{3pt}){5-5}
 & (1) & (2) & (3) & (4)\\
\midrule
ln(giving price) & -2.701*** & -1.330** & -1.477*** & -1.223**\\
 & (0.575) & (0.570) & (0.444) & (0.606)\\
\hspace{1em}X Lowest Trust & 1.668** & 0.012 & 1.014* & 0.669\\
\hspace{1em} & (0.781) & (0.798) & (0.600) & (0.784)\\
\hspace{1em}X Lower Trust & 1.058 & -0.112 & 0.514 & 0.161\\
\hspace{1em} & (0.729) & (0.718) & (0.600) & (0.791)\\
\hspace{1em}X Higher Trust & 1.727** & -0.773 & -0.068 & -0.383\\
\hspace{1em} & (0.738) & (0.765) & (0.634) & (0.834)\\
\hspace{1em}X Highest Trust & 1.557* & -0.092 & -0.099 & -0.834\\
\hspace{1em} & (0.800) & (0.770) & (0.638) & (0.880)\\
Obs & 13786 & 13438 & 35909 & 22370\\
\bottomrule
\end{tabular}
\end{table}
\end{frame}
